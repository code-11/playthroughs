...
the_walkthrough.create_block("Were2/1_reemerge.png","Reemerge",
	[
		"Everything was going well, outdoor crops were being added when suddenly...",
	]
);

the_walkthrough.create_block("Were2/2a_report.png","Report",
	[
		"The Animal Dissector rotated his head a full circle around and unearthed a hideous bloodcurdling scream.",
		"Stunned, his fellow farmers were no match for his cute little claws."
	]
);
...
the_walkthrough.create_block("Were2/5_sucks.png","Sucks",
	[
		"Unfortunately, one of the individuals under suspicion was a legendary miner :("	
	]
);
the_walkthrough.create_block("Were2/6_sucks.png","More Sucks",
	[
		"Whats worse than sealing away several crazed half man beasts? How about sealing away a innocent legendary miner with several crazed half man beasts!"	
	]
);
